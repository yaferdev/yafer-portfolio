...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        <h1 className="text-5xl md:text-8xl md:uppercase font-extrabold mb-4 bg-gradient-to-r from-cyan-400 to-blue-600 bg-clip-text text-transparent tracking-wide drop-shadow-md">
          Yafer De Leon
        </h1>
